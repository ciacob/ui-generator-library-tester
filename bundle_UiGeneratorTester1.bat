...
%javaDir%\java -jar %sdkJarsDir%\adt.jar -package -storetype pkcs12 -keystore %certHome%\claudius-iacob-certificate -target bundle ../bin-release/UiGeneratorTester1 UiGeneratorTester1-app.xml UiGeneratorTester1.swf
