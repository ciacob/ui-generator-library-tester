...
%javaDir%\java -jar %sdkJarsDir%\adt.jar -package -storetype pkcs12 -keystore %certHome%\claudius-iacob-certificate -target bundle ../bin-release/UiGeneratorTester3 UiGeneratorTester3-app.xml UiGeneratorTester3.swf
